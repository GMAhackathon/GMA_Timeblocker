...
function UserRegistrationForm(props) {
  ...
  function handleChildChange(event) {
    setChildsName(event.target.value);
  }

  function addChild(event) {
    setStudent([childsName]);
    console.log("nl: UserRegistrationForm.js: addChild: user: ", student);
    console.log(
      "nl: UserRegistrationForm.js: addChild: childsName: ",
      childsName
    );
  }
